...
class TestCases(unittest.TestCase):
   ...
   def test_earthquake_init_0(self):
   ...
   def test_earthquakes_equal_2(self):   
      quake1 = Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538)
      quake2 = Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538) 
      self.assertEqual(quake1, quake2)

   def test_earthquakes_equal_3(self):   
      quake1 = Earthquake('5km S of Gilroy, California', 23.19, -121.5697, 36.958000, 148173538)
      quake2 = Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538) 
      self.assertNotEqual(quake1, quake2)
   ...
   def test_filter_by_mag_1(self):
      ...
      self.assertEqual(filter_by_mag(quakes, 0, 1), filtered)
   ...
   def test_filter_by_mag_2(self):
      ...
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))
      filtered = []
      self.assertEqual(filter_by_mag(quakes, 0, 0.4), filtered)  
   ...
   def test_filter_by_place_1(self):
      ...
      filtered.append(Earthquake('5km S of Gilroy, california', 2.19, -121.5801697, 36.9580002, 1488173538))
      filtered.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))
      self.assertEqual(filter_by_place(quakes, "S"), filtered) 
   ...
   def test_filter_by_place_2(self):
      ...
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))
      filtered = []
      self.assertEqual(filter_by_place(quakes, "zzzz"), filtered)
   ...
   def test_filter_by_place_3(self):
      ...
      filtered = []
      filtered.append(Earthquake('12km SSW of Idyllwild, ca', 0.97, -116.7551651, 33.6391678, 1488177290))
      self.assertEqual(filter_by_place(quakes, "idyllwild"), filtered)
   ...
   def test_filter_by_place_4(self):
      ...
      filtered = []
      filtered.append(Earthquake('5km S of Gilroy, california', 2.19, -121.5801697, 36.9580002, 1488173538))
      self.assertEqual(filter_by_place(quakes, "GILROY"), filtered)

   def test_sort_by_mag_1(self):
      quakes = []
      quakes.append(Earthquake('12km SSW of Idyllwild, ca', 0.97, -116.7551651, 33.6391678, 1488177290))
      quakes.append(Earthquake('5km S of Gilroy, california', 2.19, -121.5801697, 36.9580002, 1488173538))
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))
      ...
      sort.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))
      sort.append(Earthquake('12km SSW of Idyllwild, ca', 0.97, -116.7551651, 33.6391678, 1488177290))      
      self.assertEqual(sort_by_mag(quakes), sort)

   def test_sort_by_mag_2(self):
      quakes = []
      quakes.append(Earthquake('12km SSW of Idyllwild, ca', 1.87, -116.7551651, 33.6391678, 1488177290))
      quakes.append(Earthquake('5km S of Gilroy, california', 2.89, -121.5801697, 36.9580002, 1488173538))
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 4.9, -155.2835, 58.1548, 1488219604))
      sort = []
      sort.append(Earthquake('100km SE of King Salmon, Alaska', 4.9, -155.2835, 58.1548, 1488219604))
      sort.append(Earthquake('5km S of Gilroy, california', 2.89, -121.5801697, 36.9580002, 1488173538))
      sort.append(Earthquake('12km SSW of Idyllwild, ca', 1.87, -116.7551651, 33.6391678, 1488177290))     
      self.assertEqual(sort_by_mag(quakes), sort)

   def test_sort_by_time_1(self):
      quakes = []
      quakes.append(Earthquake('12km SSW of Idyllwild, ca', 1.87, -116.7551651, 33.6391678, 1488177290))
      quakes.append(Earthquake('5km S of Gilroy, california', 2.89, -121.5801697, 36.9580002, 1488173538))
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 4.9, -155.2835, 58.1548, 1488219604))
      ...
      sort.append(Earthquake('12km SSW of Idyllwild, ca', 1.87, -116.7551651, 33.6391678, 1488177290))
      sort.append(Earthquake('5km S of Gilroy, california', 2.89, -121.5801697, 36.9580002, 1488173538))
      self.assertEqual(sort_by_time(quakes), sort)

   def test_sort_by_longitude_1(self):
      quakes = []
      quakes.append(Earthquake('12km SSW of Idyllwild, ca', 0.97, -116.7551651, 33.6391678, 1488177290))
      quakes.append(Earthquake('5km S of Gilroy, california', 2.19, -121.5801697, 36.9580002, 1488173538))
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))
      ...
      sort.append(Earthquake('5km S of Gilroy, california', 2.19, -121.5801697, 36.9580002, 1488173538)) 
      sort.append(Earthquake('12km SSW of Idyllwild, ca', 0.97, -116.7551651, 33.6391678, 1488177290))    
      self.assertEqual(sort_by_longitude(quakes), sort)

   def test_sort_by_latitude_1(self):
      quakes = []
      quakes.append(Earthquake('12km SSW of Idyllwild, ca', 0.97, -116.7551651, 33.6391678, 1488177290))
      quakes.append(Earthquake('5km S of Gilroy, california', 2.19, -121.5801697, 36.9580002, 1488173538))
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))
      ...
      sort.append(Earthquake('5km S of Gilroy, california', 2.19, -121.5801697, 36.9580002, 1488173538)) 
      sort.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))   
      self.assertEqual(sort_by_latitude(quakes), sort)
